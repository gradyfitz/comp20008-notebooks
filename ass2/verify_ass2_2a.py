...
#    Accuracy of decision tree: xx.yyy%
#    Accuracy of k-nn (k=5): xx.yyy%
#    Accuracy of k-nn (k=10): xx.yyy%
# 5. That the verification script is able to extract these from your output correctly:
#    Decision tree accuracy: xx.yyy%
#    k-nn (k=5)  accuracy: xx.yyy%
#    k-nn (k=10) accuracy: xx.yyy%
#
...
accuracy_dt_re    = r'Accuracy of decision tree:\s*(\d{0,2}(\.\d{0,3})?)'
accuracy_knn5_re  = r'Accuracy of k-nn \(k=5\):\s*(\d{0,2}(\.\d{0,3})?)'
accuracy_knn10_re = r'Accuracy of k-nn \(k=10\):\s*(\d{0,2}(\.\d{0,3})?)'
...
try:
    ...
    print("Found access to electricity median: {}, mean: {}, variance: {}".format(ate_median, ate_mean, ate_variance))
    print("Found adjusted savings median: {}, mean: {}, variance: {}".format(asped_median, asped_mean, asped_variance))
